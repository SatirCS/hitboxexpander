...
if game.PlaceId==286090429 then--game detection (Arsenal)
    local ui=loadstring(game:HttpGet("https://raw.githubusercontent.com/SatirCS/hitboxexpander/main/Coasting.lua"))()--load coasting ui lib because its cool and easy to use
